...
[GitHub Security Advisories](https://github.com/Damin3927/slimsemver/security/advisories/new).
...
`slimsemver` parses untrusted strings, and it tends to sit deep in dependency
...
ranges, mutations and garbage from a seeded PRNG and requires slimsemver and
